...
import org.moboxlab.MoBoxFrpClient.Task.TaskGetAd;
 ...
 *     "data": {
 *         "url_pic": "xxx", 广告图片url
 *         "url_jump": "xxx" 广告跳转url，格式为https://www.moboxfrp.top/ads/jump?jumpID=xx
 *     },
 *     "success": true,
 *     "message": ""
 * }
...
public class APIAdGet implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            //写入响应数据
            responseData.replace("data", BasicInfo.adInfo);
